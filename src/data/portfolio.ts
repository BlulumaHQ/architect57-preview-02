...
export const allProjects: Project[] = [
  ...
  { slug: "po-lam-temple", name: "Po Lam Temple", category: "Community & Cultural", categorySlug: "community-cultural", tags: ["Religious"], location: "Chilliwack, BC", area: "27,340 sf", budget: "$19 millions", img: poLamTemple01v2, galleryImgs: [poLamTemple01v2, poLamTemple02] },
  ...
  { slug: "willingdon-green-clinic", name: "Willingdon Green Clinic", category: "Interior Projects", categorySlug: "interior-projects", tags: ["Healthcare"], location: "Burnaby, BC", img: willingdonClinic01v2, galleryImgs: [willingdonClinic01v2] },
  ...
  { slug: "west-39-avenue", name: "West 39 Avenue", category: "Residential", categorySlug: "residential", tags: ["Multiplex"], location: "Vancouver, BC", area: "4,438 sq. ft.", budget: "$1.78 millions", img: west3901v3, galleryImgs: [west3901v3] },
...
export const featuredSlugs = ["chen-residence", "collingwood", "bridgeport-office"];

// ── Helper to get project by slug ──
export const getProjectBySlug = (slug: string) => allProjects.find(p => p.slug === slug);

// ── Helper to get project index (1-based) ──
