...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // Services
  "services.label": { en: "What We Do", zh: "服務項目" },
  "services.title1": { en: "Comprehensive", zh: "全方位" },
  "services.title2": { en: "Services", zh: "專業服務" },
  "services.desc": {
    en: "From design through delivery, we bring technical precision and creative vision to every project.",
    zh: "從設計到交付，我們為每個項目帶來精確的技術與創意願景。",
  },
  "services.cta": { en: "Discuss Your Project", zh: "洽談您的項目" },
  "services.s1.title": { en: "Integrated Building Design", zh: "整合式建築設計" },
  "services.s1.desc": {
    en: "Full-spectrum architectural design for commercial, residential, industrial, and institutional projects.",
    zh: "涵蓋商業、住宅、工業及機構的全方位建築設計。",
  },
  "services.s2.title": { en: "Code Consultation", zh: "法規諮詢" },
  "services.s2.desc": {
    en: "Complex building code consultation with CP Certified Professional expertise.",
    zh: "具備 CP 認證專業資格的複雜建築法規諮詢。",
  },
  "services.s3.title": { en: "Project Management", zh: "項目管理" },
  "services.s3.desc": {
    en: "End-to-end project management including planning, coordination, and delivery oversight.",
    zh: "端到端項目管理，包括規劃、協調及交付監督。",
  },
  "services.s4.title": { en: "Sustainable Architecture", zh: "永續建築" },
  "services.s4.desc": {
    en: "Environmentally responsible design guided by green building principles and LEED standards.",
    zh: "以綠色建築原則和 LEED 標準為指導的環保設計。",
  },
