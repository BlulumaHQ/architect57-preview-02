...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "detail.architectRole": { en: "Architect Role", zh: "建築師角色" },
  "detail.client": { en: "Client", zh: "客戶" },
  "detail.lightboxClose": { en: "Close", zh: "關閉" },
  "detail.information": { en: "Project Information", zh: "項目資訊" },
